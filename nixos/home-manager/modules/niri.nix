{ config, pkgs, ... }: {
  xdg.configFile."niri/config.kdl".text = ''
    ...
    window-rule {
	exclude app-id="com.ayugram.desktop"
  	open-maximized true
    }
    ...
    binds {
        ...
        Mod+Return hotkey-overlay-title="Open a Terminal: alacritty" { spawn "${pkgs.alacritty}/bin/alacritty"; }
	Mod+D { spawn "${pkgs.wofi}/bin/wofi" "--show" "drun" "-i" "-I" "-W" "900" "-H" "500" "-s" "/home/owppie/.config/wofi/wofi.css" "-n"; }
	Mod+E hotkey-overlay-title="Run a file manager: nemo" { spawn "${pkgs.nemo}/bin/nemo"; }
